  ...
  try {
    ...
    if (
      ...
      logs.push({
        ...
        message: `Physical Education Range changed from "${existingProject.physicalEducationRange}" to "${physicalEducationRange}" by ${performingUser.userName}`,
        userId: performingUser._id,
        timestamp: new Date(),
      });
      changesSummary.push("Physical Education Range updated");
      importantFieldsChanged = true;
      rangeFieldsChanged = true;
    }
    ...
    if (
      ...
      logs.push({
        ...
        message: `Financial Education Range changed from "${existingProject.financialEducationRange}" to "${financialEducationRange}" by ${performingUser.userName}`,
        userId: performingUser._id,
        timestamp: new Date(),
      });
